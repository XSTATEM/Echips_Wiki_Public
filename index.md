...
<div class="apple-support-container">
  ...
  <div class="header-section">
    <div class="main-logo-circle">
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.2" stroke="currentColor" class="main-svg">
        <path stroke-linecap="round" stroke-linejoin="round" d="M8.25 3v1.5M4.5 8.25H3m18 0h-1.5M4.5 12H3m18 0h-1.5m-15 3.75H3m18 0h-1.5M8.25 19.5V21M12 3v1.5m0 15V21m3.75-16.5v1.5m0 15V21m-9-1.5h10.5a2.25 2.25 0 002.25-2.25V6.75a2.25 2.25 0 00-2.25-2.25H6.75A2.25 2.25 0 004.5 6.75v10.5a2.25 2.25 0 002.25 2.25z" />
      </svg>
    </div>
...
.apple-support-container {
  ...
  position: relative;
  overflow: hidden; /* Чтобы блюр не вылезал за края */
}

/* ================= AMBIENT GLOW (Свечение на фоне для преломления) ================= */
.ambient-glow {
  position: absolute;
  border-radius: 50%;
  filter: blur(120px);
...
/* ================= УЛУЧШЕННЫЙ LIQUID GLASS EFFECT ================= */
.glass-effect {
  /* Градиент заливки для ощущения объема стекла */
  background: linear-gradient(135deg, rgba(255, 255, 255, 0.08) 0%, rgba(255, 255, 255, 0.01) 100%);
  /* Сильное размытие фона */
  backdrop-filter: blur(24px);
  -webkit-backdrop-filter: blur(24px);
  /* Базовая обводка + блики на верхней и левой гранях (имитация света) */
  border: 1px solid rgba(255, 255, 255, 0.05);
  border-top: 1px solid rgba(255, 255, 255, 0.15);
  border-left: 1px solid rgba(255, 255, 255, 0.1);
  /* Внешняя тень + Внутренний микро-блик (inner shadow) */
  box-shadow: 0 8px 32px 0 rgba(0, 0, 0, 0.2), inset 0 0 0 1px rgba(255, 255, 255, 0.02);
}

/* Специфичные стили при наведении на ЛЮБОЙ стеклянный элемент */
.glass-effect:hover {
...
.product-icon-container {
  ...
  border-radius: 22px; /* Форма Squarcle как в iOS */
...
.card-icon-container {
  color: var(--echips-coral); /* Фирменный цвет для всех иконок снизу */
  margin-bottom: 24px;
  transition: transform 0.4s ease;
}
.action-card:hover .card-icon-container { transform: scale(1.1); }
.card-svg { width: 48px; height: 48px; stroke-width: 1.5; }
...
@media (max-width: 768px) {
  ...
  .product-svg { width: 32px; height: 32px; }
  .product-item span { font-size: 13px; }
